...
from rs.common.handlers.card_reward.common_card_reward_VPG_handler import CommonCardRewardVPGHandler
...
CLAW_IS_LAW: AiStrategy = AiStrategy(
    ...
    handlers=claw_is_law_battle_potion_handlers + [
        ...
        CommonCardRewardVPGHandler(DESIRED_CARDS_FOR_DECK, DESIRED_CARDS_FROM_POTIONS),
        CommonNeowHandler(),
